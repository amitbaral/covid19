...
var flagSelector = document.getElementById("flag");
...
flagSelector.addEventListener("click", function (e) {
...
(0, _covidApi.getAllCountries)().then(function (data) {
  displayCountryList(data); //displayAllTheFlags(data);
}); //Display widget
...
var displayAllTheFlags = function displayAllTheFlags(data) {
  console.log(data);
  var element = document.getElementById("flag");
  var visualData = data.map(function (_ref3) {
    var country = _ref3.country,
        countryInfo = _ref3.countryInfo;
    return "<li id=button-".concat(countryInfo.iso3, " class=\" buttonEmulator w-full md:w-1/3 xl:w-1/5 p-3\">\n        <div  class=\"block light_grey border-b-4 border-gray-700 p-5 hoverEffect\">\n          <div class=\"flex flex-row items-center\">\n            <div class=\"flex-shrink pr-4\">\n              <img class=\"object-center sm:object-top md:object-right lg:object-bottom xl:object-left rounded-full h-16 w-16 flex items-center justify-center\" src=").concat(countryInfo.flag, " alt=").concat(country, ">\n            </div>\n            <div class=\"flex-1 text-right md:text-center font-bold text-md black text-white\">\n            ").concat(country, "\n            </div>\n          </div>\n        </div>\n      </li>");
  });
  element.innerHTML = visualData.join("");
};
